...
export function TxButton({ label, onSend, className, disabled }: TxButtonProps) {
  ...
  return (
    <AnimatedButton onClick={handleClick} disabled={loading || disabled} className={className}>
